...
const AboutUs: React.FC<AboutUsProps> = ({ config }) => {
    ...
    return (
      <div className="min-h-[70vh] flex flex-col items-center justify-center p-8 text-center bg-white">
        ...
        <p className="text-slate-500 max-w-md mx-auto leading-relaxed">
          Chúng tôi đang chuẩn bị những câu chuyện thú vị nhất để kể cho bạn
          nghe. Vui lòng quay lại sau ít phút nữa nhé!
        </p>
      </div>
    );
  }
  ...
  return (
    <div className="animate-in fade-in duration-700">
      <SEOManager
        title={config.title}
        description="Tìm hiểu về hành trình mang nông sản sạch đến mọi nhà của Thịnh Phú Food."
      />
