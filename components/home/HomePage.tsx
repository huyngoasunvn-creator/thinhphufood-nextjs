          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8 order-1 lg:order-2">
              ...
              <Link
                ...
                className="inline-flex items-center space-x-3 bg-slate-900 hover:bg-green-700 text-white px-10 py-5 rounded-2xl font-black transition-all shadow-xl shadow-slate-200 group"
              >
      ...
      <section className="py-20 bg-slate-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <header className="flex flex-col md:flex-row justify-between items-end mb-12 gap-4">
            ...
            <Link
              href="/products"
              className="text-green-700 font-bold flex items-center group"
            >
