...
export const SAMPLE_NEWS: NewsPost[] = [
  {
    ...
    summary:
      'Gạo ST25 là loại gạo ngon nhất thế giới nên bị làm giả rất nhiều. Hãy cùng ThinhPhuFood tìm hiểu cách nhận biết gạo chính hãng.',
    content: `
      ...
      <h3 class="text-xl font-bold mt-6 mb-4">1. Quan sát bao bì sản phẩm</h3>
      ...
      <h3 class="text-xl font-bold mt-6 mb-4">2. Hình dáng hạt gạo</h3>
      ...
      <h3 class="text-xl font-bold mt-6 mb-4">3. Mùi thơm đặc trưng</h3>
  ...
  },
  {
    ...
    summary:
      'Nhiều người e ngại ăn gạo lứt vì sợ khô và khó ăn. Bài viết này sẽ chia sẻ mẹo nhỏ giúp cơm gạo lứt của bạn luôn dẻo và ngọt.',
    content: `
    ...
    `,
    image:
      'https://images.unsplash.com/photo-1590424600806-2580a3203875?q=80&w=800',
    category: 'Món ngon',
    author: 'Đầu bếp xanh',
    date: '2024-05-12',
    isActive: true
